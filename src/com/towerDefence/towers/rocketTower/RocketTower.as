package com.towerDefence.towers.rocketTower {
	 ...
	 * @author Laky
	 */
	public class RocketTower extends TowerBase {
		...
		public function RocketTower() {
			...
			// графический образ
			_towerBody = new TowerRocketBody_mc();
			_towerHead = new TowerRocketHead_mc();
		}
		...
		private function shoot():void {
			trace("Бах!");
			var bullet:RocketBullet = _world.cacheGunBullet.get() as RocketBullet;
